        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 sm:mt-12 lg:mt-16 grid grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-3 lg:gap-8">
            ...
            <div className="relative bg-white rounded-2xl shadow-lg border border-gray-200 p-6 sm:p-8 mx-4 sm:mx-0">
              <div className="text-center">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900">Personnel</h3>
                <div className="mt-4 flex items-center justify-center">
                  <span className="text-3xl sm:text-4xl font-bold text-gray-900">4,99€</span>
                  <span className="ml-2 text-base sm:text-lg text-gray-500">/mois</span>
                </div>
                <p className="mt-2 text-xs sm:text-sm text-gray-500">ou 49,99€ facturé annuellement</p>
              </div>
              <ul className="mt-6 sm:mt-8 space-y-3 sm:space-y-4">
                <li className="flex items-start">
                  <span className="text-green-500 mr-3 mt-0.5">✓</span>
                  <span className="text-sm sm:text-base text-gray-700">Messages quotidiens personnalisés</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-3 mt-0.5">✓</span>
                  <span className="text-sm sm:text-base text-gray-700">Journal numérique illimité</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-3 mt-0.5">✓</span>
            ...
            <div className="relative bg-white rounded-2xl shadow-lg border-2 border-orange-500 p-6 sm:p-8 mx-4 sm:mx-0">
              ...
              <div className="text-center">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900">Cadeau</h3>
                <div className="mt-4 flex items-center justify-center">
                  <span className="text-3xl sm:text-4xl font-bold text-gray-900">4,99€</span>
                  <span className="ml-2 text-base sm:text-lg text-gray-500">/mois</span>
                </div>
              ...
              <ul className="mt-6 sm:mt-8 space-y-3 sm:space-y-4">
                <li className="flex items-start">
                  <span className="text-green-500 mr-3 mt-0.5">✓</span>
                  <span className="text-sm sm:text-base text-gray-700">Parfait pour offrir</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-3 mt-0.5">✓</span>
                  <span className="text-sm sm:text-base text-gray-700">Toutes les fonctionnalités personnelles</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-3 mt-0.5">✓</span>
            ...
            <div className="relative bg-white rounded-2xl shadow-lg border border-gray-200 p-6 sm:p-8 mx-4 sm:mx-0">
              <div className="text-center">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900">Famille</h3>
                <div className="mt-4 flex items-center justify-center">
                  <span className="text-3xl sm:text-4xl font-bold text-gray-900">3,99€</span>
                  <span className="ml-2 text-base sm:text-lg text-gray-500">/utilisateur/mois</span>
                </div>
                <p className="mt-2 text-xs sm:text-sm text-gray-500">utilisateurs illimités</p>
              </div>
              <ul className="mt-6 sm:mt-8 space-y-3 sm:space-y-4">
                <li className="flex items-start">
                  <span className="text-green-500 mr-3 mt-0.5">✓</span>
                  <span className="text-sm sm:text-base text-gray-700">Comptes famille illimités</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-3 mt-0.5">✓</span>
                  <span className="text-sm sm:text-base text-gray-700">Toutes les fonctionnalités personnelles</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div className="space-y-3 sm:space-y-4 text-center sm:text-left">
              <div className="flex items-center justify-center sm:justify-start">
                <span className="text-lg sm:text-xl font-semibold text-gray-900">Mot du jour</span>
              </div>
